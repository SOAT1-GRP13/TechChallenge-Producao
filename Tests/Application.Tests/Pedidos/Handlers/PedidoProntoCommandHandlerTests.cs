...
namespace Application.Tests.Pedidos.Handlers
{
    public class PedidoProntoCommandHandlerTests
    {
        ...
        public async Task Handle_DeveRetornarPedidoDto_QuandoPedidoAtualizadoComSucesso()
        {
            ...
            pedidoUseCaseMock.Setup(p => p.TrocaStatusPedido(guid, PedidoStatus.Pronto)).ReturnsAsync(pedidoDto);
            ...
            var handler = new PedidoProntoCommandHandler(pedidoUseCaseMock.Object, mediatorHandlerMock.Object, rabbitMQServiceMock.Object, configurationMock.Object);
        ...
        public async Task Handle_DevePublicarNotificacao_QuandoDomainExceptionLancada()
        {
            ...
            pedidoUseCaseMock.Setup(p => p.TrocaStatusPedido(guid, PedidoStatus.Pronto))
